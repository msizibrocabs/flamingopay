        ...
        <div className="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-6 gap-10">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              ...
              <li><Link href="/legal/ecta" className="hover:text-flamingo-pink">ECT Act Compliance</Link></li>
        ...
        <div className="border-t border-white/10">
          <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-white/50">
            ...
            <div className="flex items-center gap-3">
              ...
              <span aria-hidden className="text-white/30">·</span>
              <Link href="/legal/ecta" className="hover:text-flamingo-pink">ECTA</Link>
              <span aria-hidden className="text-white/30">·</span>
