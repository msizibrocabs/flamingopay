      ...
      <div className="mx-auto flex max-w-md items-center gap-3 px-4 py-3">
        {back ? (
          <button
            ...
            className="grid h-11 w-11 flex-none place-items-center rounded-full bg-white/15 hover:bg-white/25"
          >
          ...
          <Link
            ...
            className="grid h-11 w-11 flex-none place-items-center rounded-full bg-white text-flamingo-pink font-extrabold"
          >
            F
          </Link>
        )}
